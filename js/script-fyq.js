...
const defaultConfig = {
    business_name: "Mambrin Music",
    hero_title: "EXPERIENCIAS MUSICALES ÚNICAS",
    hero_subtitle: "Creamos momentos inolvidables con la música perfecta",
...
menuBtn.addEventListener('click', () => {
    ...
    if(menuOpen){
        ...
        navbar.classList.remove('parallax-bg');

        // aparece el text
        brandText.classList.add('visible');
        // cambia el color a mambrin music
        brandText.classList.add('text-white');
    } else {
        logoLarge.classList.remove('hidden')
        navbar.classList.add('bg-black');
        navbar.classList.remove('bg-black');
        navbar.classList.add('parallax-bg');
        brandText.classList.remove('visible');
        updateNavbar();
    }
